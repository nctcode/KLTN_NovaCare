...
async function main() {
  ...
  const SPECIALTY_SERVICES_MAP = {
    ...
    'Thần kinh': [
      { name: 'Đo điện brain EEG chuẩn hóa', description: 'Tầm soát động kinh, rối loạn giấc ngủ và rối loạn sóng điện não', price: 350000, duration: 30 },
      { name: 'Chụp cộng hưởng từ MRI Sọ nào', description: 'Chẩn đoán u não, phình mạch và đột quỵ sớm', price: 2200000, duration: 45 },
    ],
    'Nội tiết': [
