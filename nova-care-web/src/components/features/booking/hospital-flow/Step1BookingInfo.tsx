...
export function Step1BookingInfo({
  ...
  const { data: medicalServices = [], isLoading: loadingServices } = useQuery({
    queryKey: ['medical-services-by-hospital', hospital.id],
    queryFn: () => medicalServiceService.getAll(hospital.id),
    enabled: !!hospital.id,
  });
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-emerald-950 via-[#0c4b39] to-emerald-900 text-white rounded-3xl p-6 shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-emerald-300 text-xs font-bold border border-white/10">
            ...
            <span>Bước 1 / 4 • Thông tin khám bệnh</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        >
          <CardContent className="p-0 space-y-3">
            ...
            {selectedSpecialty ? (
              <div className="space-y-1">
                <h4 className="font-black text-slate-900 text-base text-emerald-950 flex items-center gap-2">
              ...
              <div className="py-2 text-center space-y-1">
                ...
                <p className="text-xs font-bold text-slate-700">Nhấn để chọn Chuyên Khoa</p>
                <p className="text-[11px] text-slate-400 font-medium">Popup danh mục chuyên khoa</p>
              </div>
            )}
            ...
            >
              {selectedSpecialty ? 'Thay đổi chuyên khoa' : 'Chọn chuyên khoa ngay'}
            </Button>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-0 space-y-3">
            ...
            {selectedDoctor ? (
              ...
              <div className="py-2 text-center space-y-1">
                ...
                <p className="text-xs font-bold text-slate-700">Nhấn để chọn Bác Sĩ</p>
                <p className="text-[11px] text-slate-400 font-medium">Popup danh sách bác sĩ chuyên khoa</p>
              </div>
            )}
            ...
            <Button
              ...
              className="w-full text-xs font-bold rounded-xl border-slate-300 text-slate-800 hover:bg-[#0c4b39] hover:text-white"
            >
              {selectedDoctor ? 'Thay đổi bác sĩ' : 'Chọn bác sĩ ngay'}
            </Button>
          </CardContent>
        </Card>

        {/* 3. CHỌN DỊCH VỤ (POPUP) */}
        <Card
            ...
            {selectedService ? (
              <div className="space-y-1">
                <h4 className="font-black text-slate-900 text-base flex items-center gap-2">
                  <FileText className="w-5 h-5 text-[#0c4b39]" />
              ...
              <div className="py-2 text-center space-y-1">
                ...
                <p className="text-xs font-bold text-slate-700">Nhấn để chọn Dịch Vụ Khám</p>
                <p className="text-[11px] text-slate-400 font-medium">Popup bảng giá dịch vụ y tế</p>
              </div>
            )}
      ...
      {/* 4. CHỌN NGÀY KHÁM (DATE PICKER PILLS) */}
